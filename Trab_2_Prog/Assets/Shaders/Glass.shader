    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_8519 = _RefractionTex_var.rgb.rg;
                float _Refraction_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Refraction );
                float2 sceneUVs = (i.projPos.xy / i.projPos.w) + (node_8519*_Refraction_var);
...
/////// Diffuse:
                ...
                float3 node_6074 = (length(node_8519)*_node_8773_var.rgb);
                float3 diffuseColor = ((_Color_var.rgb*_MainTex_var.rgb)+node_6074);
...
////// Emissive:
                ...
                float3 emissive = ((saturate((_DirtTexture_var.rgb*(_DirtColor_var.rgb-(node_612.r*node_612.g*node_612.b*node_612.a*_SquareRaidus_var))))*_EmissionIntensity_var)+node_6074);
/// Final Color:
